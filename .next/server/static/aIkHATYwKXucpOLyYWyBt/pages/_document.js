...
const Footer = () => __jsx("div", {
  className: "flex items-center justify-center max-w-screen-md mx-auto my-6 px-4"
}, __jsx("a", {
  href: "/feed.xml",
  target: "blank",
  className: "text-blue-400 cursor-pointer border-b-4 border-blue-400 hover:text-blue-500"
}, "RSS"), __jsx("p", {
  className: "pl-6 text-blue-400"
}, "\xA9 MELVIN GEORGE 2020"));
...
class _document_MyDocument extends document_default.a {
  ...
  render() {
    return _document_jsx(next_document["Html"], {
      lang: "en"
    }, _document_jsx(next_document["Head"], null, _document_jsx("link", {
      rel: "shortcut icon",
      type: "image/x-icon",
      href: "/favicon.ico"
    }), _document_jsx("link", {
    ...
    }, _document_jsx(next_document["Main"], null), _document_jsx(next_document["NextScript"], null), _document_jsx("footer", null, _document_jsx(Footer_Footer, null))));
  }
