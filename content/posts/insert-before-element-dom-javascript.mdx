---
title: How to add an element before a DOM element in JavaScript?
description: Learn how to use the before() DOM element method in JavaScript
keywords: before() method DOM,add element before DOM element javascript,javascript
category: JavaScript
...
See this example live in [JSBin](https://jsbin.com/hanacetole/1/edit?html,js,output).
