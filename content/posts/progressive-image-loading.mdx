...
We need to add this class to our original img tag. This makes sure that our original image starts rendering from top-left region relative to the wrapper.
...
### This is my first blog. Feel free to share if you found this useful 😃.
